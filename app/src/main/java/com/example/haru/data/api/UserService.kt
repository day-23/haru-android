...
interface UserService {
    ...
    fun requestDelFriend(
        @Path("userId") userId: String,
        @Body followingId: DelFriendBody
    ): Call<FollowResponse>
